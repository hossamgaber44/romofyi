...
<head>
    ...
    <style>
        ...
        .disabled:hover {
            background-color: rgb(89 113 157 / 45%);
            color: #588ef1;
        }
        .active:hover {
            background-color: rgb(43 169 114 / 39%);
            color: #43d796;
        }
    </style>
...
<body>
    ...
    <div class="app-container" style="overflow: auto;" >
        <div class="sidebar">
            <div class="sidebar-header">
                <div class="app-icon" style="display: flex; align-items: center;">
                    ...
                    <img style="margin-left: 12px;width: 80%;" src="../style/images/logo.png">
                </div>
            </div>
            <ul class="sidebar-list">
                <li id="listActive" class="sidebar-list-item">
                    <a href="../index.php">
                ...
                <li class="sidebar-list-item">
                    <a href="dashboard.php?page=users">
                        <svg style="fill: var(--sidebar-link);" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 640 512" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="sidebar-list-item">
                    <a href="dashboard.php?page=news_letters">
                        <svg style="fill: var(--sidebar-link);" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 512 512" fill="none"
                            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                ...
                <li class="sidebar-list-item">
                    <a href="dashboard.php?page=setting">
                        <svg style="fill: var(--sidebar-link);" xmlns="http://www.w3.org/2000/svg" width="18"
                            height="18" viewBox="0 0 512 512" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li class="sidebar-list-item">
                    <a href="./auth/logout.php">
                        <svg style="fill: var(--sidebar-link);" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
    ...
    <script src="./admin_Style/script.js"></script>
</body>
